...
- 001-plan-memory-map: Added TypeScript 5.x (ES2020 target) in-browser SPA built with Vite 5 + mind-elixir-core (fork), lightweight utility helpers only (built-in Blob/File APIs for download; no network deps)
